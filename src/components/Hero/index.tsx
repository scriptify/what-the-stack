        ...
        <main className='mx-auto mb-20 max-w-7xl px-4 sm:mt-24 lg:mb-0'>
          ...
          <div className='mt-8 text-center'>
            <h1 className='mt-16 mb-8 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:my-0'>
              <span className=''>Mit modernen Developer Tools</span>
              <br />
            ...
            <p className='mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl'>
              ...
              Tooling und klobiger User Experience! Sorge dafür, dass sich Dein
              Dev-Team auf das fokussiert, was es am besten kann: Shippen von
              neuen Features.
            </p>
